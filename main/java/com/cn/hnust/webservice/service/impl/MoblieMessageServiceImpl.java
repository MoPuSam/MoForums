package com.cn.hnust.webservice.service.impl;
...
import com.cn.hnust.webservice.service.MoblieMessageService;
 ...
 */
@WebService
public class MoblieMessageServiceImpl implements MoblieMessageService{
...
//初始化ascClient需要的几个参数
        ...
        //必填:短信签名-可在短信控制台中找到
        request1.setSignName("云通信");
        //必填:短信模板-可在短信控制台中找到
        request1.setTemplateCode("SMS_1000000");
